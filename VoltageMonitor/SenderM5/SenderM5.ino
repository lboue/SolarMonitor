...
void draw() {
  ...
  for (int i = 0; i < 6; i++)
    spr.drawString("0x" + String(broadcastAddress[i], HEX) + ",", 30 + (i * 30),
                   176);
  ...
  for (int i = 0; i < 12; i++)
    spr.drawSmoothArc(28, 140, 20, 14, i + (i * 30), i + (i * 30) + 24,
                      grays[11], TFT_BLACK);
  for (int i = 0; i < bri; i++)
    spr.drawSmoothArc(28, 140, 20, 14, i + (i * 30), i + (i * 30) + 24, orange,
                      TFT_BLACK);
